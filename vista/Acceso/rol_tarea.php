...
<html lang="en">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Registrar Rol Tarea</h4>
        </div>
          ...
          <div class="row">            
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                <label for="cboRol" class = "control-label col-md-3 col-sm-3 col-xs-12">Rol * :</label>
              ...
              <div class="form-group">
                <label for="cboTarea" class = "control-label col-md-3 col-sm-3 col-xs-12">Tarea * :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select id="cboTarea" class="form-control col-md-7 col-xs-12" required>
  ...
  <div class="modal fade" id="modalUpdate">
    <div class="modal-dialog alerta">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Editar Rol Tarea</h4>
        </div>
        <div class="modal-body">
          <div class="row">            
            <form id="demo-form" data-parsley-validate class="form-horizontal form-label-left">             
              ...
              <div class="form-group">
                <label for="cboRolE" class = "control-label col-md-3 col-sm-3 col-xs-12">Rol * :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                <label for="cboTareaE" class = "control-label col-md-3 col-sm-3 col-xs-12">Tarea * :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select id="cboTareaE" class="form-control col-md-7 col-xs-12" required>
  ...
  <!-- modal eliminar-->
    <div class="modal fade" id="modalEliminar">
      <div class="modal-dialog alerta">
        <div class="modal-content">
          <div class="modal-header">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <h4> ¿Desea eliminar este rol tarea? </h4>
              </div>
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          </div>
          <div class="modal-body">
    ...
    <script src="../js/Acceso/despachadorRolTarea.js"></script>
