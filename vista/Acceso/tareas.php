...
<html lang="en">
          ...
          <div class="row">            
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                <label for="cboGrupo" class = "control-label col-md-3 col-sm-3 col-xs-12">Grupo * :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select id="cboGrupo" class="form-control col-md-7 col-xs-12" required>
              ...
              <div class="form-group">
                <label for="txtUrl" class = "control-label col-md-3 col-sm-3 col-xs-12">Url:</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="txtUrl" class="form-control col-md-7 col-xs-12" name="txtUrl" required />
                </div>                        
              </div>           
          ...
          <div class="row">            
            <form id="demo-form" data-parsley-validate class="form-horizontal form-label-left">
              <div class="form-group">
                <label for="cboGrupo" class = "control-label col-md-3 col-sm-3 col-xs-12">Grupo * :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select id="cboGrupoE" class="form-control col-md-7 col-xs-12" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="txtDescripcionE" required="required" class="form-control col-md-7 col-xs-12" name="txtDescripcionE" ></textarea>
                </div>                        
              </div>

              <div class="form-group">
                <label for="txtUrlE" class = "control-label col-md-3 col-sm-3 col-xs-12">Url:</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="txtUrlE" class="form-control col-md-7 col-xs-12" name="txtUrlE" required />
                </div>                        
              </div>  
  ...
  <!-- modal eliminar-->
   ...
   <!-- jQuery -->
    ...
    <script src="../js/Acceso/despachadorTarea.js"></script>
